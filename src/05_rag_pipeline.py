...
#     # ... (Initialization of embedding_model_global, client_global, collection_global, etc. from Step 1) ...

#     print("\n--- Testing Full RAG Pipeline ---")
#     test_queries_for_rag = [
#         "What is a confidence interval according to the text?",
#         "Explain Maximum Likelihood Estimation principles.",
#         # "Describe pivotal quantities and their use." # Add more specific queries
#     ]

#     for test_query in test_queries_for_rag:
#         q_gen, a_gen, ctx_used = generate_qa_via_rag(test_query)

#         print("\n**************************************************")
#         print(f"USER QUERY: {test_query}")
#         print("**************************************************")
#         # print(f"\nCONTEXT SNIPPET USED (first 500 chars):\n{ctx_used[:500]}...") # Uncomment for deep debug
...
#         elif q_gen:
#             print(f"\nGENERATED QUESTION:\n{q_gen}")
#             print("\nGENERATED ANSWER: [Could not parse or was not provided clearly]")
#         else:
#             print("\nQ&A GENERATION FAILED for this query.")
#         print("**************************************************\n")
    
#     print("\n--- End of Day 4 Script ---")

if __name__ == "__main__":
    # ... (Initialization of embedding_model_global, collection_global, etc.) ...

    print("\n--- Testing Topic-Based Q&A Generation ---")
    test_topics = [
    ...
    for topic in test_topics:
        print(f"\n\n>>>>>>>>>>>>>>>> Topic: {topic} <<<<<<<<<<<<<<<<<<")
        qa_set, context_used = generate_topic_qa_set(topic, num_questions=3)
        ...
        if qa_set:
            ...
            print("Q&A set generation failed for this topic.")
        print("**************************************************\n")
